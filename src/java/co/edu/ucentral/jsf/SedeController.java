...
public class SedeController implements Serializable {
    ...
    @EJB
    private co.edu.ucentral.bean.SedeFacade ejbFacade;
    ...
    public Sede getSede(java.lang.Integer id) {
