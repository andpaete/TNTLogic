...
import co.edu.ucentral.modelo.Estadosolicitud;
import co.edu.ucentral.jsf.util.JsfUtil;
import co.edu.ucentral.jsf.util.PaginationHelper;
import co.edu.ucentral.bean.EstadosolicitudFacade;
...
public class EstadosolicitudController implements Serializable {
    ...
    @EJB
    private co.edu.ucentral.bean.EstadosolicitudFacade ejbFacade;
